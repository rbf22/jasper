"""Track heap growth via mallinfo2 per iteration."""
...
rss0 = rss_kb()
print(f"Baseline: RSS={rss0//1024}MB arena={arena0//1024}KB used={used0//1024}KB free={free0//1024}KB mmap={mmap0//1024}KB")
